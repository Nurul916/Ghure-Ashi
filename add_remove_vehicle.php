...
session_start();
    $con = mysqli_connect("localhost", "root","", "ghureashi");
...
{ 
   ...
   elseif(isset($_GET['areaname']))
    ...
    if(isset($_POST['id']))
    {
        ...
        $query1= "DELETE FROM `lveh` WHERE id LIKE '$id'";
...
<body>
    ...
    <div class="container">
        <form class="form-horizontal my-3" method="post" action=" ">
                            ...
                            ?>
                            <a href="write_vehicle.php" class="btn btn-primary mb-5 mt-1 float-right" aria-label="Search" name="wb" id="wb"><strong>Add vehicles</strong></a>
                             <?php } ?>
                                    
                            <button type="submit" class="btn btn-primary" method=''>Search</button>
<br>
<br>
<br>
                        </form>
    ...
    <div class="container my-5">
        <div class="text-center" style="margin: 150px;">
            <h2 class="featurette-heading">Sorry no Vehicles Found. </h2>
        </div>
    </div>
    <?php
    }
    ...
    <div class="container my-5">
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7 order-md-1">
                <form action="add_remove_vehicle.php" class="mb-3" method="post">
                
                <h2 class="featurette-heading">ID: <?php echo $details['id'] ?> </h2>
                <h2><span class="text-muted">Driver Name: <?php echo $details['driver_name'] ?></span></h2>
                <p class="lead">Contact No: <?php echo $details['contact'] ?></p>
                <p class="lead">Driver's License: <?php echo $details['driver_license'] ?></p>
                <p class="lead">Driver's NID : <?php echo $details['nid'] ?></p>
                <p class="lead">Vehicle's Number: <?php echo $details['v_number'] ?></p>
                <p class="lead">Hire Rate : <?php echo $details['hire_rate'] ?></p>
                <p class="lead">Capacity : <?php echo $details['seat'] ?></p>
