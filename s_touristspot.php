...
<?php if(!isset($_GET['areaname'])){ ?>
    ...
    <form class="container form-horizontal my-5" action=" ">
        ...
        <div class="text-center" style="margin: 150px;">
            <h2 class="featurette-heading">Search For Tourist Spots </h2>
        </div>
    </div>
    </div>
...
<?php 
    ...
    <div class="container my-5" style="box-shadow: 5px 10px 10px 5px #888888;">
        <div class="row featurette d-flex justify-content-center box-shadow align-items-center">
            <div class="col-md-7 order-md-1">
              <h2 class="featurette-heading ml-5"> <?php echo $r[$i][0]?> </h2>
                <h4><span class="text-muted ml-5">Location: <?php echo $r[$i][2] ?></span></h4>
                
            </div>
            <div class="col-md-5 order-md-2 my-4">
                <?php echo '<img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
                    height="500" src="data:image/jpeg;base64,'.base64_encode( $r[$i][3] ).'"alt="" style="border:5px solid black"/>';?>
            </div>
        </div>
    </div>
