...
$num=null;
 ...
 elseif (isset($_GET['areaname']))
    ...
    {
        $query= "SELECT * FROM `nearby_restaurants`";
        $queryfire = mysqli_query($con,$query);
        $num= mysqli_num_rows($queryfire);
    ...
    if(isset($_POST['id']))
    {
        ...
        $query1= "DELETE FROM `nearby_restaurants` WHERE id LIKE '$r_id'";
...
<div class="container">
        <form class="form-horizontal my-3" method="post" action=" ">
                            ...
                            if(isset($_SESSION['Aemail'])){
                            ?>
                            <a href="write_restaurant.php" class="btn btn-primary mb-5 mt-4 float-right" aria-label="Search" name="wb" id="wb"><strong>Add new restaurant</strong></a>
                            <?php } ?>
                            </div>
...
<br>
    ...
    <div class="container my-5">
        <div class="text-center" style="margin: 150px;">
            <h2 class="featurette-heading">Sorry No Restaurant Found. </h2>
        </div>
    </div>
    <?php
    }
    ...
    <div class="container my-5">
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7 order-md-1">
                <form action="add_remove_restaurant.php" class="mb-3" method="post">
                ...
                <p class="lead">Address: <?php echo $details['r_address'] ?></p>
                <p class="lead">Contact: <?php echo $details['contact_no'] ?></p>
                <p class="lead">Type: <?php echo $details['type'] ?></p>
