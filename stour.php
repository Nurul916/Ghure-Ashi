...
if(isset($_GET['areaname'])){
    $area=$_GET['areaname'];
    $sql="SELECT name, 
             contact,hire_rate,image,area,id
             FROM tour_guide
  ...
  <?php  if(isset($_SESSION['Aname']))
    ...
    <div class="container my-5">
        <div class="text-center" style="margin: 150px;">
            <h2 class="featurette-heading"> No Tour Guide Found </h2>
        </div>
    </div>
    <?php
    }
    ...
    <div class="container my-5">
        <div class="row featurette d-flex justify-content-center align-items-center">
            <div class="col-md-7 order-md-1">
                ...
                <h4><span class="text-muted">Address: <?php echo $r[$i][4] ?></span></h4>
                <p class="lead">Price: <?php echo $r[$i][2] ?> BDT</p>
                <p class="lead">Contact NO: <?php echo $r[$i][1] ?> </p>
                <form class="form-inline" action="checkavail.php">
                    ...
                    <button type="submit" class="btn btn-primary mb-2 mx-3" name="tid" value="<?php echo $r[$i][5]?>">Search</button>
                </form>
            </div>
            <div class="col-md-5 order-md-2">
                <?php echo '<img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="400"
                    height="400" src="data:image/jpeg;base64,'.base64_encode( $r[$i][3] ).'"alt="" style="border:5px solid black"/>';?>
            </div>
        </div>
    </div>
    ...
    <form class="form-horizontal mx-3 my-3" action=" ">
        ...
        <div class="container my-5">
        <div class="text-center" style="margin: 150px;">
            <h2 class="featurette-heading">Search For Your Tour Guide </h2>
        </div>
    </div>
<?php }
    ?>
